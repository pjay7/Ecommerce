...
//        product.setQuantity(product.getQuantity());
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        Cart usetCart = cartRepository.findCartByEmail(emailId);
        Long cartId = usetCart.getCartId();
    ...
    public String deleteProductFromCart(Long cartId, Long productId) {
        ...
        CartItem cartItem = cartItemRepository.findCartItemByProductIdAndCartId(cartId, productId);
        if(cartId == null) throw new ResourceNotFoundException("Product", "productId", productId);
    ...
    public void updateProductsInCarts(Long cartId, Long productId) {
        ...
        CartItem cartItem = cartItemRepository.findCartItemByProductIdAndCartId(cartId, productId);
        if(cartItem == null) throw new APIException("Product "+ product.getProductName() +" not available in cart");
